...
class Pan extends JPanel{
	...
	static int T = 0;
	static int[] HistoTurn = new int[200];
	static int[] Historical = new int[120];
	static int[][] HistoChess = new int[8][8];
	static int[][] HistoPiece = new int[8][8];
...
//******Placement of the Pieces	
	...
	public static void HistoRefresh(){
		Historical[0]=WP1x;
		Historical[1]=WP1y;
		Historical[2]=WP1Taken;
		Historical[3]=WP1Promotion;
		Historical[4]=WP2x;
		Historical[5]=WP2y;
		Historical[6]=WP2Taken;
		Historical[7]=WP2Promotion;
		Historical[8]=WP3x;
		Historical[9]=WP3y;
		Historical[10]=WP3Taken;
		Historical[11]=WP3Promotion;
		Historical[12]=WP4x;
		Historical[13]=WP4y;
		Historical[14]=WP4Taken;
		Historical[15]=WP4Promotion;
		Historical[16]=WP5x;
		Historical[17]=WP5y;
		Historical[18]=WP5Taken;
		Historical[19]=WP5Promotion;
		Historical[20]=WP6x;
		Historical[21]=WP6y;
		Historical[22]=WP6Taken;
		Historical[23]=WP6Promotion;
		Historical[24]=WP7x;
		Historical[25]=WP7y;
		Historical[26]=WP7Taken;
		Historical[27]=WP7Promotion;
		Historical[28]=WP8x;
		Historical[29]=WP8y;
		Historical[30]=WP8Taken;
		Historical[31]=WP8Promotion;
		Historical[32]=WK1x;
		Historical[33]=WK1y;
		Historical[34]=WK1Taken;
		Historical[35]=WK2x;
		Historical[36]=WK2y;
		Historical[37]=WK2Taken;
		Historical[38]=WB1x;
		Historical[39]=WB1y;
		Historical[40]=WB1Taken;
		Historical[41]=WB2x;
		Historical[42]=WB2y;
		Historical[43]=WB2Taken;
		Historical[44]=WR1x;
		Historical[45]=WR1y;
		Historical[46]=WR1Taken;
		Historical[47]=WR1NeverMoved;
		Historical[48]=WR2x;
		Historical[49]=WR2y;
		Historical[50]=WR2Taken;
		Historical[51]=WR2NeverMoved;
		Historical[52]=WQx;
		Historical[53]=WQy;
		Historical[54]=WQTaken;
		Historical[55]=WKgx;
		Historical[56]=WKgy;
		Historical[57]=WKgTaken;
		Historical[58]=WKgNeverMoved;

		Historical[59]=BP1x;
		Historical[60]=BP1y;
		Historical[61]=BP1Taken;
		Historical[62]=BP1Promotion;
		Historical[63]=BP2x;
		Historical[64]=BP2y;
		Historical[65]=BP2Taken;
		Historical[66]=BP2Promotion;
		Historical[67]=BP3x;
		Historical[68]=BP3y;
		Historical[69]=BP3Taken;
		Historical[70]=BP3Promotion;
		Historical[71]=BP4x;
		Historical[72]=BP4y;
		Historical[73]=BP4Taken;
		Historical[74]=BP4Promotion;
		Historical[75]=BP5x;
		Historical[76]=BP5y;
		Historical[77]=BP5Taken;
		Historical[78]=BP5Promotion;
		Historical[79]=BP6x;
		Historical[80]=BP6y;
		Historical[81]=BP6Taken;
		Historical[82]=BP6Promotion;
		Historical[83]=BP7x;
		Historical[84]=BP7y;
		Historical[85]=BP7Taken;
		Historical[86]=BP7Promotion;
		Historical[87]=BP8x;
		Historical[88]=BP8y;
		Historical[89]=BP8Taken;
		Historical[90]=BP8Promotion;
		Historical[91]=BK1x;
		Historical[92]=BK1y;
		Historical[93]=BK1Taken;
		Historical[94]=BK2x;
		Historical[95]=BK2y;
		Historical[96]=BK2Taken;
		Historical[97]=BB1x;
		Historical[98]=BB1y;
		Historical[99]=BB1Taken;
		Historical[100]=BB2x;
		Historical[101]=BB2y;
		Historical[102]=BB2Taken;
		Historical[103]=BR1x;
		Historical[104]=BR1y;
		Historical[105]=BR1Taken;
		Historical[106]=BR1NeverMoved;
		Historical[107]=BR2x;
		Historical[108]=BR2y;
		Historical[109]=BR2Taken;
		Historical[110]=BR2NeverMoved;
		Historical[111]=BQx;
		Historical[112]=BQy;
		Historical[113]=BQTaken;
		Historical[114]=BKgx;
		Historical[115]=BKgy;
		Historical[116]=BKgTaken;
		Historical[117]=BKgNeverMoved;


		//HistoChess = Chessboard;
		//HistoPiece = Pieceboard;
		//Historical[118]=HistoChess;
		//Historical[119]=HistoPiece;
		}

	public int[] PieceXY(int Px, int Py){
		int[] Pxy = new int[2];
		for(int i=0; i<8; i++){
			for(int j=0; j<8; j++){
				if (Px==25+i*100 && Py==725-j*100){
					Pxy[0]=i;
					Pxy[1]=j;
					break;
					}
...
*/
		...
		while (pan.gameplay==0) System.out.print("\b");
